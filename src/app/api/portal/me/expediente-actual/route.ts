...
import type { PortalExpedienteActualResponse } from "@/types/portal-expediente-actual";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await fetchUpstream<PortalExpedienteActualResponse>({
      url: `${base}/portal/me/expediente-actual`,
      headers,
    });
