...
import type { PortalProductosResponse } from "@/types/portal-productos";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await fetchUpstream<PortalProductosResponse>({
      url: withQueryParams(req, `${base}/portal/me/productos`),
      headers,
    });
