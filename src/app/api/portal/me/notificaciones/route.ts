...
import type { PortalNotificacionesResponse } from "@/types/portal-notificaciones";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await fetchUpstream<PortalNotificacionesResponse>({
      url: withQueryParams(req, `${base}/portal/me/notificaciones`),
      headers,
    });
