...
import type { PortalHorarioSucursalItem } from "@/types/portal-sucursales";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await fetchUpstream<PortalHorarioSucursalItem[]>({
      url: `${base}/portal/me/sucursales/horarios`,
      headers,
    });
