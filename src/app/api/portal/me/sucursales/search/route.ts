...
import type { PortalSucursalesResponse } from "@/types/portal-sucursales";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await fetchUpstream<PortalSucursalesResponse>({
      url: withQueryParams(req, `${base}/portal/me/sucursales/search`),
      headers,
    });
