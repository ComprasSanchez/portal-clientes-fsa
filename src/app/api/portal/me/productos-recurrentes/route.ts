...
import type { PortalProductosRecurrentesResponse } from "@/types/portal-productos";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await fetchUpstream<PortalProductosRecurrentesResponse>({
      url: `${base}/portal/me/productos-recurrentes`,
      headers,
    });
